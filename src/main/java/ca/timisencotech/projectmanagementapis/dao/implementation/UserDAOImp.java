...
public class UserDAOImp implements UserDAO {
	...
	public <T> Container<T> addNewUser(User user) {
		...
		UserSignUpDetails findUserSignUpDetails = userSignUpRepo.findUserSignUpDetailsByEmail(user.getUserEmail());
		...
		Application.getLogger().info("addNewUser method in User DAO Implementation. At this point unable to find foreign key email in the database");
		...
		UserDetails responseUserDetails = null;
			 try {
				 ...
				 responseUserDetails = userRepo.save(newUserDetails);
				 ...
				 Application.getLogger().info("addNewUser method in User DAO Implementation. At this point new user has successful saved to the database. Return userdetails from repo is"+domainUserDetail);
				 ...
				 Application.getLogger().info("addNewUser method in User DAO Implementation. At this point there is an error that has prevented saving new user to the database");
