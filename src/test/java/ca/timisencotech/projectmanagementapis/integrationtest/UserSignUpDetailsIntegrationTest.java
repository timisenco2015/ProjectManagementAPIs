...
public class UserSignUpDetailsIntegrationTest {
	...
	public void addUserLoginDetailsTest() 
		 ...
		 HttpHeaders headers = new HttpHeaders();
	       ...
	       HttpEntity<UserSignUpDetail> entity = new HttpEntity<>(userSignUpDetail, headers);
	        ResponseEntity<String> response = restTemplate.postForEntity("http://localhost:8080/projectmanagement/newUserSignUpDetail", entity,String.class);
