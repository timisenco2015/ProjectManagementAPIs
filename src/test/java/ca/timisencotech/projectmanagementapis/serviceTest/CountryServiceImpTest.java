...
@SpringBootTest
public class CountryServiceImpTest<T> {
		...
		public void addCountryTest() throws JSONException 
		 {
			//checks that add service can call country repo save method
			 ...
			 Container<T> countryContainer = countryService.addCountry(country, binder.getBindingResult());
			...
			binder = new DataBinder(country);
			 countryContainer = countryService.addCountry(country, binder.getBindingResult());
